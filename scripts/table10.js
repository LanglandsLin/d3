...
// }
 ...
 d3.csv("table10a.csv").then(function(data) {
  console.log(data);
  var margin = ({top: 50, right: 0, bottom: 0, left: 40})
  ...
  var rect = series.selectAll("rect")
   ...
   function mouseout(D, I){    // utility function to be called on mouseout.
    ...
    var piesvg = d3.select("#table10").append("svg")
        .attr("class", "pie")
   ...
   var legend = d3.select("#table10").append("table").attr('class','legend');
